...
def row(summary: dict) -> dict:
    ...
    return {
        ...
        "main_peak": spread("main_prompt_peak"),
        "sub_peak": spread("sub_prompt_peak"),
        "delegations": spread("delegations"),
        "sub_overflows": spread("sub_overflows"),
        "sub_salvaged": spread("sub_salvaged"),
        "checkpoints": spread("sub_checkpoints"),
    }
