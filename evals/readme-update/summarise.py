...
METRICS = (
    ...
    # the orchestrator and its subagents, apart: a run's pathology is usually in one of the two
    ("main_prompt_peak", ("stats", "main", "prompt_tokens_peak")),
    ("main_turns", ("stats", "main", "turns")),
    ("main_compactions", ("stats", "main", "compactions")),
    ("main_checkpoints", ("stats", "main", "checkpoints")),
    ("delegations", ("stats", "sub", "count")),
    ("sub_prompt_peak", ("stats", "sub", "prompt_tokens_peak")),
    ("sub_rounds_mean", ("stats", "sub", "rounds_mean")),
    ("sub_answered", ("stats", "sub", "answered")),
    ...
    ("open_todos", ("stats", "main", "open_todos")),
    ("readme_lines", ("damage", "lines")),
)
